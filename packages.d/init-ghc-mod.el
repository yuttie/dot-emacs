...
(define-key haskell-mode-map (kbd "C-c C-j") #'ghc-flymake-jump)
...
(define-key haskell-mode-map (kbd "M-?")     #'ghc-flymake-display-errors)
...
(define-key haskell-mode-map (kbd "C-c C-c") #'ghc-flymake-toggle-command)
